...
<?xfa generator="WIN_XDCEDIT_V1.0" APIVersion="3.6.13048.0"?>
   ...
   <deviceInfo>
      ...
      <!-- ========================================== -->
			...
			<barcodes>
					...
					<barcodeDefinition type="aztec" support="software" wideNarrowRatio="fixed" moduleWidth="0.125mm-1.25mm" moduleHeight="0.125mm-1250mm"/>
					<barcodeDefinition type="rfid" support="none" wideNarrowRatio="fixed"/>
			
					<!-- Label Barcode Definitions (added from zpl300.xdc, but not exclusive to zebra printers -->
